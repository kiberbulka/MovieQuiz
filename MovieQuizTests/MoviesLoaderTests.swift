    ...
    func testSuccessLoading() throws {
            ...
            // Then
                ...
                case .success(let movies):
                    ...
                    XCTAssertEqual(movies.items[0].title, "Prey (2022)") // Проверяем название первого фильма
                    XCTAssertEqual(movies.items[1].title, "The Gray Man (2022)") // Проверяем название второго фильма
                }
                expectation.fulfill()
            }
